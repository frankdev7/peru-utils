...
provinces.set('0207', { code: '0207', name: 'Carlos Fermin Fitzca' });
...
provinces.set('0508', { code: '0508', name: 'Paucar del Sara Sara' });
...
provinces.set('0701', { code: '0701', name: 'Callao' });
...
provinces.set('1103', { code: '1103', name: 'Nazca' });
...
provinces.set('1608', { code: '1608', name: 'Maynas' });
...
provinces.set('1802', { code: '1802', name: 'General Sanchez Cerr' });
provinces.set('1803', { code: '1803', name: 'Ilo' });
provinces.set('1901', { code: '1901', name: 'Pasco' });
provinces.set('1902', { code: '1902', name: 'Daniel Alcides Carri' });
...
provinces.set('2110', { code: '2110', name: 'San Antonio de Putin' });
...
provinces.set('2402', { code: '2402', name: 'Contralmirante Villa' });
